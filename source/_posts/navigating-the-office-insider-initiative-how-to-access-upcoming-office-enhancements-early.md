...
date: 2024-08-28 12:36:52
updated: 2024-08-29 12:36:36
tags:
  - excel
categories:
  - tech
...
## Navigating the Office Insider Initiative: How to Access Upcoming Office Enhancements Early
...
Related: [What Is Microsoft 365?](https://games-able.techidaily.com/ultimate-console-content-psplus-or-xbox-game-pass/) 

 You'll need a [Microsoft 365](https://games-able.techidaily.com/ultimate-console-content-psplus-or-xbox-game-pass/) Personal or Family subscription to install the builds. If you have a subscription through your work or school, you'll need your Microsoft 365 administrator to assist you with receiving the builds.

##  Which Systems and Apps Are Supported?

 You can join the program using a Windows, Mac, Android, or iOS Office supported device. Review the [system requirements for Microsoft 365](https://www.microsoft.com/en-us/microsoft-365/microsoft-365-and-office-resources?rtc=1) and those for [specifically for Office Mobile apps](https://www.microsoft.com/en-us/microsoft-365/microsoft-365-and-office-resources?rtc=1#coreui-heading-3b8v07b).
...
###  Join on a Mobile Device
 ...
 On iPhone, you'll need to use [TestFlight](https://testflight.apple.com) which you can install like any other app on the App Store. Then, visit the [Office Insider program page for iOS](https://insider.office.com/en-us/join/iOS) and install the builds per each application link in the list. Then, follow the prompts for each.

##  How Do You Provide Feedback?

 As an Office Insider, Microsoft hopes to receive feedback from you on the new features you see and try. If you'd like to offer your feedback, you can do so from one of the applications or via the [Feedback Portal](https://feedbackportal.microsoft.com/feedback).

![Office Insider Program feedback on Windows](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2022/07/Feedback-OfficeInsiderProgram.png) 
